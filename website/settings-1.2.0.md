...
External protocol resolvers
---------------------------
### Use server-provided name
Default: `false`

```
set("extproto.use_server_name",false)
```
...
Default: ```
"/usr/local/lib/liquidsoap/1.2.0/liquidtts"```


```
set("say.program","/usr/local/lib/liquidsoap/1.2.0/liquidtts")
```
