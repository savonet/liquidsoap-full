...
Default: ```
["META","WAV","MIDI","FLAC","AAC","MP4","OGG","MAD","CAMLIMAGES","SDL/IMAGE"]```


```
set("decoder.file_decoders",["META","WAV","MIDI","FLAC","AAC","MP4","OGG","MAD","CAMLIMAGES","SDL/IMAGE"])
```
...
Default: ```
["WAV","PCM/BASIC","FLAC","AAC","OGG","MAD"]```


```
set("decoder.stream_decoders",["WAV","PCM/BASIC","FLAC","AAC","OGG","MAD"])
```
