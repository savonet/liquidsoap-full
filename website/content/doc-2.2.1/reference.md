...
- `headers` (of type `[string * string]`, which defaults to `[("User-Agent", "Liquidsoap/2.2.1 (Unix; OCaml 4.14.1)")]`): Additional headers.
- `(unlabeled)` (of type `[string * string]`)
...
- `user_agent` (of type `string`, which defaults to `"Liquidsoap/2.2.1 (Unix; OCaml 4.14.1)"`): User agent.
- `(unlabeled)` (of type `{string}`): URL to decode.
...
(?id : string?, ?dir_perm : int, ?extra_tags : [string], ?fallible : bool,
 ...
 ?start : bool, ?strict_persist : bool, ?temp_dir : string?,
 ?segment_name : ((position : int, extname : string, string) -> string),
