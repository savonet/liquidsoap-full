...
*Note* These instructions are from the documentation from liquidsoap `1.3.7`.
...
```
opam depext taglib mad lame vorbis cry samplerate liquidsoap.1.3.7
opam install taglib mad lame vorbis cry samplerate liquidsoap.1.3.7
```
