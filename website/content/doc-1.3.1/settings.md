...
Default: ```
["META","WAV","AIFF","MIDI","IMAGE","AAC","MP4","MAD","GSTREAMER"]```


```
set("decoder.file_decoders",["META","WAV","AIFF","MIDI","IMAGE","AAC","MP4","MAD","GSTREAMER"])
```
...
Default: ```
["WAV","AIFF","PCM/BASIC","RAW AUDIO","AAC","MAD","GSTREAMER"]```


```
set("decoder.stream_decoders",["WAV","AIFF","PCM/BASIC","RAW AUDIO","AAC","MAD","GSTREAMER"])
```
...
Default: `["MP4","TAGLIB","GSTREAMER"]`

```
set("request.metadata_decoders",["MP4","TAGLIB","GSTREAMER"])
```
