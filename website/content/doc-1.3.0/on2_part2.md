...
![Initial stream model](/assets/img/on2_part2_schema1.svg)This very simple stream is defined by the following content
in `radio.liq`:
...
![Advanced stream model](/assets/img/on2_part2_schema2.svg)* The `Replay gain` node normalizes all the songs using the [Replay Gain](http://replaygain.org) technology.
...
operator, that takes a function of type ```
