...
Default: ```
["META","WAV","MIDI","FLAC","AAC","MP4","OGG","MAD","CAMLIMAGES","SDL/IMAGE","GSTREAMER"]```


```
set("decoder.file_decoders",["META","WAV","MIDI","FLAC","AAC","MP4","OGG","MAD","CAMLIMAGES","SDL/IMAGE","GSTREAMER"])
```
...
Default: ```
["video/x-ms-asf","video/x-msvideo","video/mp4","video/3gpp","video/webm","video/x-matroska"]```


```
set("decoder.mime_types.gstreamer",["video/x-ms-asf","video/x-msvideo","video/mp4","video/3gpp","video/webm","video/x-matroska"])
```
